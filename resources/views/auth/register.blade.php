            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5" style="font-family:'Arial', sans-serif">Welcome!</h1>
                        <p class="text-lead text-white">Create an account in the form below.Warning!We love math over here!!!</p>
                    </div>
                </div>
            </div>
        </div>
